...
//Promesas en cadena,el valor de 'result se va modificando
//a medida se avanza en la cadena
...
//Promise.all() con promesas rechazadas
...
let promise2All2 = new Promise((resolve, reject) => {
    ////resolve(2);
    //resolve('Promesa 2');
    setTimeout(() => reject('Promesa 2'), 3000);
});
let promise2All3 = new Promise((resolve, reject) => {
    setTimeout(() => resolve(3), 1000);
});
Promise.all([promise2All1, promise2All2, promise2All3])
    .then((response) => {
